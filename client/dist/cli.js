...
import { findFreePort, saveAgentConfig, saveInstanceConfig, listInstances, loadInstanceConfig, loadAgentConfig, clawhomeDir, } from "./storage.js";
...
program
    ...
    const agentConfig = yaml.load(fs.readFileSync(tplPath, "utf-8"));
...
program
    ...
    for (const id of instances) {
        try {
            ...
            console.log(`  ${id}  type=${cfg.agentType}  port=${cfg.localPort}  status=${status}  server=${cfg.serverUrl}`);
        }
        catch {
